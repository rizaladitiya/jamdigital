...
<footer class="main-footer">
    <div class="pull-right hidden-xs">
        NIM <b><?=$this->about_model->get_by_nama('nim')->row()->value;?></b>
    </div>
    Copyright &copy; 2017 by <strong><?=$this->about_model->get_by_nama('creator')->row()->value;?></strong> | <?=$this->about_model->get_by_nama('program')->row()->value;?>
</footer>
</div><!-- ./wrapper -->
