...
<body class="skin-blue">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            <a href="#" class="logo"><?=$this->about_model->get_by_nama('program')->row()->value;?></a>
                        ...
                        <li class="dropdown user user-menu">
                          ...
                          <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                              ...
                              <p>
                                <?=$this->about_model->get_by_nama('creator')->row()->value;?> <?=$this->about_model->get_by_nama('nim')->row()->value;?>
                                <small>Ubhara</small>
                              </p>
                            </li>
